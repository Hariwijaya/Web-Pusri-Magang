...
<body class="bg-gray-100">
    ...
    <div id="sidebar"
        ...
        <nav class="p-4">
            <ul>
                ...
                <li class="mb-4">
                    <a href="/penjualan/index.php?=sparepart"
                        class="flex items-center text-white hover:bg-gray-500 p-2 rounded">
    ...
    <div id="mainContent" class="ml-64 p-6 transition-all duration-300">
        <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6">
            <h2 class="text-2xl font-semibold mb-6 text-gray-800">Tambah Sparepart</h2>
            <form action="../controllers/sparepartController.php" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                        ...
                        id="nm_sparepart" name="nm_sparepart" required />
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        class="form-input mt-1 block w-full p-3 border rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                        id="spesifikasi" name="spesifikasi" required></textarea>
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-gray-700 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 focus:outline-none">Tambah
                        Sparepart</button>
                    <a href="/penjualan/views/daftar_sparepart.php"
                        class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 focus:outline-none">Kembali</a>
                </div>
            </form>
        </div>
    </div>
